...
$.libro.URL = '/GestionBiblioteca/webresources/com.iesvdc.acceso.entidades.libro';
...
$.libro.LibroReadREST = function(id) {
    if ( id === undefined ) {
        ...
        $.ajax({
            url: 'http://localhost:8084/GestionBiblioteca/webresources/com.iesvdc.acceso.entidades.libro',
            type: 'GET',
            dataType: 'json',
            success: function (json) {
...
$.libro.LibroCreateREST = function(){
       var datos = { 
           ...
           'codigoISBN':$("#c_li_CodIsbn").val(),
           'fechaDevolucion':$('#c_li_FechaDevol').val()+"T00:00:00+02:00", 
           'fechaPrestamo': $('#c_li_FechaPrestamo').val()+"T00:00:00+02:00", 
                  };
    ...
    if ( id === undefined ) {
        ...
        //HACEMOS LA LLAMADA REST
            ...
            if ( datos.nombre.length>2 && datos.codigoISBN.length>2 && datos.autor.length>2 &&
               datos.fechaPrestamo.length>2 && datos.fechaDevolucion.length>2) {
                $.ajax({
